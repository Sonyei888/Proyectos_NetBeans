...
public class libro extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        datoslb tve=new datoslb ("El legendario asesino de magos","Lucio Almiron","Nn","100");
        jLabel6.setText(tve.getTitulo());
        jLabel7.setText(tve.getAutor());
        jLabel8.setText(tve.getEditorial());
        jLabel9.setText(tve.getCapitulos());
        //cambie las paginas por capitulos por que es un libo virtual y en si no tiene paginas 
